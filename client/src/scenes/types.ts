...
export type SceneMode = 'editor' | 'program';
...
export interface TextObjectProperties { text: string; fontFamily: string; fontSize: number; fontWeight: number; align: 'left' | 'center' | 'right'; color: string; }
