...
export interface SceneObject { id: string; type: SceneObjectType; role: SceneObjectRole; name: string; x: number; y: number; width: number; height: number; rotation: number; opacity: number; visible: boolean; locked: boolean; z: number; properties: Record<string, unknown>; }
