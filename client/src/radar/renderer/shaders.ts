...
in vec2 a_pos; in float a_value; in float a_state; uniform mat4 u_matrix; out float v_value; flat out float v_state; void main(){gl_Position=u_matrix*vec4(a_pos,0.0,1.0);v_value=a_value;v_state=a_state;}`;
